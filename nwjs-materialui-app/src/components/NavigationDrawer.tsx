        ...
        <Drawer variant="permanent" anchor="left">
            ...
            <List>
                ...
                <ListItem
                    button
                    component={Link}
                    to="/usdc-solana-transactions"
                    sx={isActive('/usdc-solana-transactions') ? { bgcolor: 'action.selected' } : {}}
                >
                    <ListItemText primary="USDC (Solana) Transactions" />
                </ListItem>
                <ListItem
                    button
                    component={Link}
                    to="/solana-transactions"
                    sx={isActive('/solana-transactions') ? { bgcolor: 'action.selected' } : {}}
                >
                    <ListItemText primary="Solana Transactions" />
                </ListItem>
                <ListItem
                    button
                    component={Link}
                    to="/polkadot-transactions"
                    sx={isActive('/polkadot-transactions') ? { bgcolor: 'action.selected' } : {}}
                >
                    <ListItemText primary="Polkadot Transactions" />
                </ListItem>
                <ListItem
                    button
                    component={Link}
                    to="/sui-transactions"
                    sx={isActive('/sui-transactions') ? { bgcolor: 'action.selected' } : {}}
                >
                    <ListItemText primary="Sui Transactions" />
                </ListItem>
                <ListItem
                    button
                    component={Link}
